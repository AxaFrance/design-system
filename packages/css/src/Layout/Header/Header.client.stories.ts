  ...
  render: (args) => {
    ...
    header.innerHTML = `
      <div class="af-header-container">
        <img class="af-logo" src="${args.logo}" alt="Logo Axa">
      </div>
    `;
...
export const HeaderWithLinks: StoryObj = {
  render: (args) => {
    ...
    header.innerHTML = `
      <div class="af-header-container">
        <div class="af-header-nav">
          <img class="af-logo" src="${args.logo}" alt="Logo Axa">
          <ul class="af-header-menu">
            <li class="af-header-menu-link af-header-menu-link--active"><a>MES CONTRATS</a></li>
            <li class="af-header-menu-link"><a>MES AVANTAGES</a></li>
            <li class="af-header-menu-link"><a>MES DOCUMENTS</a></li>
          </ul>
        </div>
      </div>
    `;
...
export const HeaderWithLinksAndButton: StoryObj = {
  render: (args) => {
    const header = document.createElement("header");
    header.innerHTML = `
      <div class="af-header-container">
        ...
        <div class="af-header-right-item" role="button">
          ${args.children}
        </div>
      </div>
    `;
  ...
  args: {
    children: `
    <div style="color:#00008f;font-size:0.9rem;display:flex;flex-direction:row;align-items:center;gap:0.7rem">
      ...
      <svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M7.86422 0.303942C7.7792 0.218158 7.66018 0.166687 7.54116 0.166687C7.42214 0.166687 7.30311 0.218158 7.2181 0.303942L4.03 3.52085H3.97049L0.782391 0.303942C0.697375 0.218158 0.578353 0.166687 0.45933 0.166687C0.340308 0.166687 0.221286 0.218158 0.13627 0.303942C0.0512537 0.389726 0.000244141 0.509824 0.000244141 0.629922C0.000244141 0.750021 0.0512537 0.870118 0.13627 0.955903L3.32437 4.16424L3.97899 4.83335L4.67612 4.17281L7.86422 0.947324C7.94923 0.86154 8.00024 0.741442 8.00024 0.621344C8.00024 0.501246 7.94923 0.389726 7.86422 0.303942Z" fill="#00008F"/>
      </svg>
    </div>
    `,
  },
