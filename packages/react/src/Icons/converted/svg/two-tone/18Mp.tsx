...
const Svg18Mp = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M13.5 6.5H15V8h-1.5zM13.5 9H15v1.5h-1.5z" opacity={0.3} />
    <path
    ...
    <path d="M8.5 11.5H10v-6H7V7h1.5zM13 11.5h2.5c.55 0 1-.45 1-1v-4c0-.55-.45-1-1-1H13c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1m.5-5H15V8h-1.5zm0 2.5H15v1.5h-1.5z" />
  </svg>
);
