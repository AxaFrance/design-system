...
describe("<LevelSelectorCommon />", () => {
  describe("render", () => {
    ...
    it("applies selected class to labels based on value", () => {
      ...
      expect(labels[0]).toHaveClass("af-level-selector__selected");
      expect(labels[1]).toHaveClass("af-level-selector__selected");
      expect(labels[2]).not.toHaveClass("af-level-selector__selected");
    });
  });
