...
describe("Alert component", () => {
  it("should render error by default correctly", () => {
    render(<MessageBar title="Error: information is required" />);
  ...
  it("should render warning correctly", () => {
    render(
      <MessageBar variant="warning" title="Warning: information is missing" />,
    );
  ...
  it("shouldn't have an accessibility violation <MessageBar />", async () => {
    // Act
