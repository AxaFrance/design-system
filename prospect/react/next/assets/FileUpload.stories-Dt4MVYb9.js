import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{t as n}from"./jsx-runtime-CXZ2plg1.js";import{it as r,t as i,tt as a}from"./prospect-B_thSnYS.js";var o=t({Playground:()=>l,__namedExportsOrder:()=>u,default:()=>c}),s,c,l,u,d=e((()=>{i(),s=n(),c={title:`Components/Form/FileUpload/FileUpload`,component:r,argTypes:{label:{control:`text`},description:{control:`text`},required:{control:`boolean`},helper:{control:`text`},message:{control:`text`},dropzoneLabels:{control:`object`},messageType:{control:`select`,options:[`error`,`success`,`warning`]},moreButtonLabel:{table:{disable:!0}},sideButtonLabel:{table:{disable:!0}},onSideButtonClick:{table:{disable:!0}},onMoreButtonClick:{table:{disable:!0}},labelProps:{table:{disable:!0}},children:{table:{disable:!0}},fileListLabel:{control:`text`}},args:{label:`Joindre un justificatif de domicile`,description:`Description`,required:!1,helper:`2 fichiers max. / pdf, png, jpg, jpeg, gif / 5 Mo par fichier`,message:``,dropzoneLabels:{dropzone:``,or:``,button:``},fileListLabel:``}},l={render:({fileListLabel:e,description:t,helper:n,label:i,message:o,dropzoneLabels:c,...l})=>{let u={};return c?.dropzone&&(u.dropzone=c.dropzone),c?.or&&(u.or=c.or),c?.button&&(u.button=c.button),(0,s.jsxs)(r,{...l,dropzoneLabels:Object.keys(u).length>0?u:void 0,fileListLabel:e||void 0,description:t||void 0,helper:n||void 0,label:i||void 0,message:o||void 0,children:[(0,s.jsx)(a,{file:new File([new Uint8Array(1496)],`Wallpaper.jpg`,{type:`image/jpg`})}),(0,s.jsx)(a,{file:new File([new Uint8Array(5159852)],`Document.pdf`,{type:`application/pdf`}),errorMessage:`Le fichier que vous souhaitez importer est supérieur à 5 Mo.`})]})}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: ({
    fileListLabel,
    description,
    helper,
