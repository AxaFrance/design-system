import{s,X as m}from"./ExitLayoutApollo-C8lkrE4B.js";/* empty css               */import{j as n}from"./jsx-runtime-D_zvdyIk.js";import"./index-ZnYipkzV.js";const g=()=>n.jsx("div",{className:"af-tag-client-demo",children:Object.values(m).map(e=>n.jsx(s,{variant:e,children:e},e))}),T=({children:e,variant:o,...u})=>n.jsxs(s,{variant:o,...u,children:[e," ",o]});g.__docgenInfo={description:"",methods:[],displayName:"renderTagAll"};T.__docgenInfo={description:"",methods:[],displayName:"renderTag"};const y={component:s,title:"Components/Tag",parameters:{layout:"centered"},argTypes:{}},r={name:"Tag",render:T,args:{children:"Tag",variant:"info"},argTypes:{variant:{options:Object.values(m),control:{type:"select"}}}},a={render:g};var t,c,d;r.parameters={...r.parameters,docs:{...(t=r.parameters)==null?void 0:t.docs,source:{originalSource:`{
  name: "Tag",
  render: renderTag,
  args: {
    children: "Tag",
