const l=(e,a,t,s)=>{const n=document.createElement("button");return n.innerHTML=e,a&&(n.innerHTML=`${a}${n.innerHTML}`),n.className=["af-btn-client",s?`af-btn-client--${s}`:""].join(" "),n},d=()=>{const e=document.createElement("div");return e.className="af-header-previous-link-container",e.innerHTML=`
      ...
      `,e},m=e=>{const a=document.createElement("nav"),t=document.createElement("ul");return t.className="af-navbar-container",t.role="menubar",t.innerHTML=`
          <li class="af-navbar-item" role="none"><a class="af-navbar-item__link af-navbar-item__link--active" role="menuitem" href="/mes-contrats">${e[0]}</a></li>
          <li class="af-navbar-item" role="none"><a class="af-navbar-item__link"  role="menuitem" href="/mes-avantages">${e[1]}</a></li>
          <li class="af-navbar-item" role="none"><a class="af-navbar-item__link" role="menuitem" href="/mes-documents">${e[2]}</a></li>
      `,a.append(t),a},C=e=>{const a=document.createElement("header");a.classList.add("af-header");const t=document.createElement("div");t.classList.add("af-header-container");const s=document.createElement("div");s.classList.add("af-header-left-item");const n=document.createElement("img");n.classList.add("af-logo"),n.setAttribute("src",e.logo),n.setAttribute("alt",e.alt);const r=m(e.links),i=document.createElement("div");i.classList.add("af-header-right-item");const o=l("Mon Profil",`
        ...
        `,void 0,"ghost"),c=l("Espace Banque",`
        ...
        `,void 0,"secondary");return s.append(n),s.append(r),i.append(c),i.append(o),t.append(s),t.append(i),a.append(t),a};export{l as a,d as b,m as g,C as r};
