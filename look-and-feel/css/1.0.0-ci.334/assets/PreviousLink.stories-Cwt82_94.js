/* empty css                     */const o={title:"Components/Header/PreviousLink"},e={render:()=>{const n=document.createElement("div");return n.className="af-header-previous-link-container",n.innerHTML=`
        ...
        </a>`,n}};var r,a,s;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: () => {
...
}`,...(s=(a=e.parameters)==null?void 0:a.docs)==null?void 0:s.source}}};const i=["Default"];export{e as Default,i as __namedExportsOrder,o as default};
