/* empty css                 */const C={title:"Components/Form/Input/FileUpload"},s={render:i=>{const e=document.createElement("div");return e.innerHTML=`
...
</div>`,e},args:{label:"Label",buttonLabel:"Importer fichier",dropZoneDescription:"Glissez/déposez vos fichiers",filesListLabel:"Vos fichiers",required:!0},argTypes:{label:{control:{type:"text"}}}};var l,n,a;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: args => {
...
}`,...(a=(n=s.parameters)==null?void 0:n.docs)==null?void 0:a.source}}};const f=["Default"];export{s as Default,f as __namedExportsOrder,C as default};
