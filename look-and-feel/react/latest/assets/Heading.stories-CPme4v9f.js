import{j as o}from"./index-C-iqcyhV.js";import"./constants-CAfflvme.js";import"./FileUploadCommon-BZUq6j8J.js";import"./index-ZnYipkzV.js";import{H as t}from"./FileUploadLF-CAVpz7bd.js";import{b as m}from"./account_balance_wallet-fill-DXqnmHYk.js";const p=n=>o.jsx("div",{className:"af-heading-client-demo",children:[1,2,3].map(a=>o.jsx(t,{...n,level:a},`story-heading-${a}`))});p.__docgenInfo={description:"",methods:[],displayName:"renderAllHeading"};const u={component:t,title:"Components/Heading",args:{children:"Titre de la page"},argTypes:{className:{type:"string"},iconProps:{control:"object"},tagProps:{control:"object"}}},e={render:n=>o.jsx(t,{...n}),args:{firstSubtitle:"Sous titre 1",secondSubtitle:"Sous titre 2",tag:"Texte",icon:m},argTypes:{level:{options:[1,2,3],control:"inline-radio"}}},r={args:{...e.args},render:p};var s,i,d;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
