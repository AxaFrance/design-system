const o={title:"Components/Header/NavBar"},n={render:({activeIndex:a})=>{const e=document.createElement("div");return e.innerHTML=`
        <button class="mask fade show" type="button"></button>
            <nav class="af-nav af-drawer left show" role="navigation" aria-label="Menu principal">
                <div class="container af-nav__wrapper">
                    ...
                    <ul class="af-nav__list" role="menubar" aria-labelledby="menubutton" id="idmenu">
                        <li class="af-nav__item${a===0?" af-nav__item--active":""}" role="none">
                          <a class="af-nav__link" role="menuitem" href="/home" tabindex="0">Home</a>
                        </li>
                        <li class="af-nav__item af-nav__item--haschild${a===1?" af-nav__item--active":""}" role="none">
                        ...
                        <li class="af-nav__item${a===2?" af-nav__item--active":""}" role="none">
                          <a class="af-nav__link" role="menuitem" href="/accordion" tabindex="-1">Accordions</a>
                        </li>
                        <li class="af-nav__item af-nav__item--haschild${a===3?" af-nav__item--active":""}" role="none">
            ...
            </nav>`,e.className="af-nav-container",e},args:{activeIndex:0},argTypes:{activeIndex:{control:{type:"number",min:0,max:3}}}};var l,i,s;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: ({
    activeIndex
  }) => {
...
}`,...(s=(i=n.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const t=["Default"];export{n as Default,t as __namedExportsOrder,o as default};
