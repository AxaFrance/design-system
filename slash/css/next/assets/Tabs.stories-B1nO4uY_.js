const l={title:"Components/Tabs"},a={render:t=>{const n=document.createElement("div");return n.className="af-tabs",n.innerHTML=`
        <ul class="af-tabs__control">
            <li class="af-tabs__item af-tabs__item--has-icon-left${t.activeIndex===0?" af-tabs__item--active":""}">
            ...
            <li class="af-tabs__item af-tabs__item--has-icon-right${t.activeIndex===1?" af-tabs__item--active":""}">
                <button class="af-tabs__link">
                    <span>${t.secondTitle}
            ...
            <li class="af-tabs__item${t.activeIndex===2?" af-tabs__item--active":""}">
                <button class="af-tabs__link">
                    <span>
                        ${t.thirdTitle}<span class="af-badge af-badge--danger"> ${t.badgeContent}</span>
                    </span>
                </button>
            </li>
        </ul>
        <div class="af-tabs__content">
            <div class="af-tabs__pane">${t.content}</div>
        </div>`,n},args:{activeIndex:0,firstTitle:"Title with left icon",secondTitle:"Title with right icon",thirdTitle:"Title with badge",badgeContent:"42",content:"Content of my first tab"}};var s,e,i;a.parameters={...a.parameters,docs:{...(s=a.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: args => {
...
}`,...(i=(e=a.parameters)==null?void 0:e.docs)==null?void 0:i.source}}};const c=["Default"];export{a as Default,c as __namedExportsOrder,l as default};
