/* empty css              */const i={title:"Components/Form/Input/Checkbox"},a={render:({label:e})=>{const s=document.createElement("div");return s.innerHTML=`
    <div class="col-md-2">
        <label class="af-form__group-label">${e}</label>
    </div>
    <div class="col-md-10">
    ...
    </div>`,s.className="af-form__group row af-form__group--label-top",s},args:{label:"Classic Checkbox"},argTypes:{}};var c,o,l;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: ({
    label
  }) => {
  ...
  argTypes: {}
}`,...(l=(o=a.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};const r=["Default"];export{a as Default,r as __namedExportsOrder,i as default};
