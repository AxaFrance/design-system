const n={title:"Components/Steps"},p=["past","on","disabled"],s={render:a=>{const e=document.createElement("div");return e.innerHTML=`
    <div class="af-steps-new">
        <ol class="af-steps-list">
            <li class="${a.mode} af-steps-list-step number" title="Previous step">
    ...
    </div>`,e},args:{mode:"past"},argTypes:{mode:{options:p,control:{type:"select"}}}};var t,l,i;s.parameters={...s.parameters,docs:{...(t=s.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: args => {
...
}`,...(i=(l=s.parameters)==null?void 0:l.docs)==null?void 0:i.source}}};const r=["NewStepsDesign"];export{s as NewStepsDesign,r as __namedExportsOrder,n as default};
