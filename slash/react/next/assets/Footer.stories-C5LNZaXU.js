import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{F as t}from"./Loader-D_HZkG_i.js";/* empty css              */import"./index-DbaA8R3S.js";import"./index-BdSKqQiB.js";const p={title:"Components/Footer",component:t,parameters:{options:{}}},r={name:"Default",render:({children:d,...l})=>e.jsx(t,{...l,children:d})},o={name:"Core with HTML children",render:()=>e.jsxs(t,{children:[e.jsx("a",{href:"https://www.axa.fr/",target:"blank",children:e.jsxs("strong",{children:["@ ",new Date().getFullYear()," AXA"]})}),e.jsx("em",{children:"Tous droits réservés"})]})};var s,n,a;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  name: "Default",
  render: ({
    children,
    ...args
