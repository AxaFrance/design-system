import{j as e}from"./index-DK-fRI8B.js";/* empty css              */import{a as M}from"./Loader-Dph_CslH.js";import"./index-DbaA8R3S.js";import{f as L}from"./index-C2cC0QQF.js";const j=["success","info","danger","error"],x={title:"Components/Alert",component:M,args:{onClose:L()}},r={args:{title:"Attention: Ceci est une alerte"},argTypes:{classModifier:{options:j,control:{type:"select"}}}},n={args:{classModifier:"danger",title:"Attention: des informations sont manquantes",icon:"glyphicon glyphicon-alert"}},s={args:{classModifier:"info",title:"Attention: des informations sont manquantes",icon:"glyphicon glyphicon-info-sign"}},o={args:{classModifier:"success",title:"Succès: votre demande a bien été enregistrée.",icon:"glyphicon glyphicon-ok",ariaLabel:"Tata"}},t={args:{classModifier:"error",title:"Erreur dans les champs suivants :",icon:"glyphicon glyphicon-minus-sign",children:e.jsxs("ul",{children:[e.jsx("li",{children:"Le nom est obligatoire"}),e.jsx("li",{children:"Le prénom est obligatoire"}),e.jsx("li",{children:"L'email est obligatoire"}),e.jsx("li",{children:"Le format de date est invalide"})]})}};var i,a,l;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
