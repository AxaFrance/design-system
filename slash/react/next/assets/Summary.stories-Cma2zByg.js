import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{a as h}from"./Loader-D5xiBZCh.js";/* empty css              */import"./index-DbaA8R3S.js";import"./index-BdSKqQiB.js";import{g as x}from"./generateId-LF6-RKcC.js";import{f as o}from"./index-28pPPJTf.js";const i=({messages:e=[],isVisible:g=!0,title:p="Invalid form",classModifier:f="error",...y})=>{const S=e.filter(a=>!!a);return!e||!g||S.length===0?null:s.jsx(h,{icon:"glyphicon glyphicon-warning-sign",title:p,classModifier:f,...y,children:s.jsx("ul",{className:"af-summary__message-list",children:e.map(a=>s.jsx("li",{className:"af-summary__message-item",children:a},`message_${x({message:a})}`))})})},_={title:"Components/Summary",component:i,argTypes:{classModifier:{options:["success","info","danger","error"],control:{type:"select"}}},args:{onClose:o()}},b=["Field Author is required","Field PlaceName is required"],r={name:"Simple Summary in error",render:e=>s.jsx(i,{...e}),args:{messages:b,isVisible:!0,onClose:o(),classModifier:"error"}},n={name:"Summary in success with react nodes in messages",render:e=>s.jsx(i,{...e}),args:{messages:[s.jsx("strong",{children:"This text is in bold"},"1"),s.jsx("em",{children:"and this one in italic"},"2")],title:"Congratulations on submitting a flawless form",isVisible:!0,onClose:o(),classModifier:"success"}};var t,m,l;r.parameters={...r.parameters,docs:{...(t=r.parameters)==null?void 0:t.docs,source:{originalSource:`{
