import{j as r}from"./jsx-runtime-D_zvdyIk.js";/* empty css               */import{F as s}from"./CardData-BOncjv5M.js";import"./index-ZnYipkzV.js";import"./index-63p0MazF.js";const p={title:"Components/Footer",component:s,parameters:{options:{}}},e={name:"Default",render:({children:t,...l})=>r.jsx(s,{...l,children:t})},o={name:"Core with HTML children",render:({...t})=>r.jsxs(s,{...t,children:[r.jsx("a",{href:"https://www.axa.fr/",target:"blank",children:r.jsxs("strong",{children:["@ ",new Date().getFullYear()," AXA"]})}),r.jsx("em",{children:"Tous droits réservés"})]})};var n,a,m;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  name: "Default",
  render: ({
    children,
    ...args
