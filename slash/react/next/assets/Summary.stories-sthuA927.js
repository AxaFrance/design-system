import{j as s}from"./jsx-runtime-D_zvdyIk.js";/* empty css               */import"./CardData-Dqmws-JC.js";import"./index-DbaA8R3S.js";import"./index-CG6JzWRx.js";import{M as x}from"./Message-DtCzNT1n.js";import{g as _}from"./generateId-LF6-RKcC.js";import{f as o}from"./index-28pPPJTf.js";const i=({messages:e=[],isVisible:p=!0,title:f="Invalid form",classModifier:t="error",...S})=>{const y=e.filter(n=>!!n);if(!e||!p||y.length===0)return null;const h=t==="danger"?"warning":t;return s.jsx(x,{title:f,variant:h,...S,children:s.jsx("ul",{className:"af-summary__message-list",children:e.map(n=>s.jsx("li",{className:"af-summary__message-item",children:n},`message_${_({message:n})}`))})})},b={title:"Components/Summary",component:i,argTypes:{classModifier:{options:["success","info","danger","error"],control:{type:"select"}}},args:{onClose:o()}},j=["Field Author is required","Field PlaceName is required"],r={name:"Simple Summary in error",render:e=>s.jsx(i,{...e}),args:{messages:j,isVisible:!0,onClose:o(),classModifier:"error"}},a={name:"Summary in success with react nodes in messages",render:e=>s.jsx(i,{...e}),args:{messages:[s.jsx("strong",{children:"This text is in bold"},"1"),s.jsx("em",{children:"and this one in italic"},"2")],title:"Congratulations on submitting a flawless form",isVisible:!0,onClose:o(),classModifier:"success"}};var m,l,c;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
