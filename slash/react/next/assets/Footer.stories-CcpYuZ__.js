import{j as e}from"./index-DK-fRI8B.js";/* empty css              */import{F as t}from"./Loader-Dph_CslH.js";import"./index-DbaA8R3S.js";const p={title:"Components/Footer",component:t,parameters:{options:{}}},r={name:"Default",render:({children:d,...l})=>e.jsx(t,{...l,children:d})},o={name:"Core with HTML children",render:()=>e.jsxs(t,{children:[e.jsx("a",{href:"https://www.axa.fr/",target:"blank",children:e.jsxs("strong",{children:["@ ",new Date().getFullYear()," AXA"]})}),e.jsx("em",{children:"Tous droits réservés"})]})};var s,n,a;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  name: "Default",
  render: ({
    children,
    ...args
