import{j as e}from"./jsx-runtime-D_zvdyIk.js";/* empty css              */import{o as h,s as f,l as x,M as j,a as y}from"./Loader-DJsQniMZ.js";import"./index-DbaA8R3S.js";import"./index-CG6JzWRx.js";const T=r=>{switch(r){case"get":return"Chargement en cours";case"post":return"Sauvegarde en cours";case"delete":return"Suppression en cours";case"update":return"Mise à jour en cours";case"error":return"Une erreur est survenue lors du chargement du composant";default:return""}},m=({className:r,text:n,children:u,classModifier:p,mode:a="none"})=>{const t=h(r,p,"af-loader"),o=n||T(a),g=a!=="none",l=a==="error";return e.jsxs("div",{className:t,children:[u,g?e.jsx("div",{className:`${t} af-loader-on`,children:e.jsxs("div",{className:"af-spinner",role:"alert","aria-live":"assertive","aria-busy":!l,"aria-label":o,children:[!l&&e.jsx("div",{className:"af-spinner__animation"}),e.jsx("div",{className:"af-spinner__caption",children:o})]})}):null]})},b={component:m,title:"Components/Loader",parameters:{layout:"fullscreen"}},s={name:"Loader",render:({children:r,...n})=>e.jsx(m,{...n,children:r}),args:{mode:"get",text:"",children:e.jsxs("form",{style:{height:"100vh",padding:"3rem"},children:[e.jsx(f,{children:"A form asking for your name"}),e.jsx(x,{label:"name",message:"error",messageType:j.error}),e.jsx(y,{children:"Send"})]})},argTypes:{children:{table:{disable:!0}}}};var i,d,c;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`{
  name: "Loader",
  render: ({
    children: text,
    ...args
