...
}`,...(t=(s=r.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};var l,i,c;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => {
    return <div className="icon-list">\r
        <ul>\r
          {glyphicon.map(icon => <li key={icon}>\r
              <span className={\`glyphicon glyphicon-\${icon}\`} />\r
              <span className="icon-list__icon-name">{icon}</span>\r
            </li>)}\r
        </ul>\r
      </div>;
  },
  tags: ["!dev"]
}`,...(c=(i=a.parameters)==null?void 0:i.docs)==null?void 0:c.source}}};const u=["Glyphicon","AllIcons"],g=Object.freeze(Object.defineProperty({__proto__:null,AllIcons:a,Glyphicon:r,__namedExportsOrder:u,default:d},Symbol.toStringTag,{value:"Module"}));export{a as A,r as G,g as I};
