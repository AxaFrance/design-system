import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{f as b}from"./index-Bm9fFANh.js";import{A as j}from"./Alert-CuYko3ZB.js";const x=["success","info","danger","error"],E={title:"Components/Alert",component:j,args:{onClose:b()}},n={args:{title:"Attention: Ceci est une alerte"},argTypes:{classModifier:{options:x,control:{type:"select"}}}},r={args:{classModifier:"danger",title:"Attention: des informations sont manquantes",icon:"glyphicon glyphicon-alert"}},s={args:{classModifier:"info",title:"Attention: des informations sont manquantes",icon:"glyphicon glyphicon-info-sign"}},o={args:{classModifier:"success",title:"Succès: votre demande a bien été enregistrée.",icon:"glyphicon glyphicon-ok"}},t={args:{classModifier:"error",title:"Erreur dans les champs suivants :",icon:"glyphicon glyphicon-minus-sign",children:e.jsxs("ul",{children:[e.jsx("li",{children:"Le nom est obligatoire"}),e.jsx("li",{children:"Le prénom est obligatoire"}),e.jsx("li",{children:"L'email est obligatoire"}),e.jsx("li",{children:"Le format de date est invalide"})]})}};var i,a,c;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
