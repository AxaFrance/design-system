...
The summary is used to display a list of messages related to a user action.
It is a variation of the alert component.

The component takes a `messages` props which is an array of strings or JSX elements.
...
The modifiers are the same as in the Action component: `error`, `info`, `success` and `warning`.
