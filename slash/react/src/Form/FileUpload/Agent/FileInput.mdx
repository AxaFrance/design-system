...
```javascript
import { FileInput } from "@axa-fr/design-system/agent";
```
...
```javascript
import { File } from "@axa-fr/design-system/agent";
```
...
```javascript
import { File, FileTable, HelpMessage } from "@axa-fr/design-system/agent";
```
