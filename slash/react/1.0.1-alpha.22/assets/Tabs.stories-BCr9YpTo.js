import{j as e}from"./jsx-runtime-Cw0GR0a5.js";import{f as d}from"./index-C_FWhylE.js";import{B as b}from"./Badge-CAZ-Dv6m.js";import{e as a}from"./BooleanModal-DByG5Ucd.js";const g={title:"Components/Tabs",component:a,parameters:{options:{}},argTypes:{onChange:{action:"tab changed"}},args:{onChange:d()}},h=e.jsxs("span",{children:[e.jsx("i",{className:"glyphicon glyphicon-ok"})," Title with left icon"]}),f=e.jsxs("span",{children:["Title with right icon ",e.jsx("i",{className:"glyphicon glyphicon-facetime-video"})]}),m=e.jsxs("span",{children:["Title with badge ",e.jsx(b,{classModifier:"danger",children:" 42 "})]}),p=e.jsxs("span",{children:["Title with badge and left icon",e.jsx(b,{classModifier:"error",children:" Lorem ipsum "}),e.jsx("i",{className:"glyphicon glyphicon-facetime-video"})]}),n={render:s=>e.jsx(a,{...s,children:e.jsx(a.Tab,{title:"My Title",children:"Content of my single tab"})}),args:{activeIndex:"0"},argTypes:{onChange:{action:"onChange"}}},t={render:s=>e.jsxs(a,{...s,children:[e.jsx(a.Tab,{title:h,classModifier:"has-icon-left",children:"Content of my first tab"}),e.jsx(a.Tab,{title:f,classModifier:"has-icon-right",children:"Content of my second tab"}),e.jsx(a.Tab,{title:m,children:"Content of my third tab "}),e.jsx(a.Tab,{title:p,classModifier:"has-icon-left",children:"Content of my fifth tab"})]}),args:{activeIndex:"1"},argTypes:{onChange:{action:"onChange"}}};var o,i,r;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
