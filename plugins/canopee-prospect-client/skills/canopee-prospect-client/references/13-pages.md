...
import { ValidPage, type ValidPageProps } from '@axa-fr/canopee-react/client';
```
...
>
    <p>
        Vous recevrez votre attestation d'assurance par email dans les 24
        heures.
    </p>
    <p>Pour toute question, contactez votre conseiller.</p>
</ValidPage>
```
...
// Client / Look and Feel
import { ErrorPage, type ErrorPageProps } from '@axa-fr/canopee-react/client';
```
...
>
    <p>
        Une erreur technique a empêché le traitement de votre demande. Veuillez
        réessayer ultérieurement ou contacter notre service client.
    </p>
</ErrorPage>
```
...
> Dans le Storybook Look and Feel, les MDX de pages doivent importer depuis `@axa-fr/canopee-react/client`.
