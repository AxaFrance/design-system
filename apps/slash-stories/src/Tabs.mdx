...
<Controls of={TabsStories.SingleTab} />
...
const TabTitleBadge = (
  <span>
    Title with badge <Badge className="danger"> 42 </Badge>
  </span>
);
const TabTitleIconBadge = (
  <span>
    Title with badge and left icon
    <Badge className="error"> Lorem ipsum </Badge>
...
<Controls of={TabsStories.ComplexTabs} />
