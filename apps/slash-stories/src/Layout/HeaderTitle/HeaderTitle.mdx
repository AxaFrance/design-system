...
If you need to have a navbar with anchors, you can use the `anchorNavBarItems` property. The `HeaderTitle` component will then show the `AnchorNavBar` component with the items you provide.
