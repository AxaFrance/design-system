...
You can pass children instead of options to have the possibilitie to use optgroup.

"options" prop is deprecated and will be deleted in a future version.

### `Select` With children

<Canvas of={SelectStories.SelectStoryWithChildren} />
<Controls of={SelectStories.SelectStoryWithChildren} />
### `Select` With options - Deprecated
