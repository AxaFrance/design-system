import { TextArea, itemMessageVariants } from "@axa-fr/canopee-react/prospect";
...
const meta: Meta<typeof TextArea> = {
  ...
  argTypes: {
    ...
    moreButtonLabel: { control: { type: "text" } },
    sideButtonLabel: { control: { type: "text" } },
    onMoreButtonClick: { action: "button clicked" },
