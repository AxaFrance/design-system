        ...
        <form className="form">
          ...
          <div className="form__fields subgrid">
            ...
            <Message variant={messageVariants.information}>
              Pour tout autre type de bien (manoir, château, mobil-home...),
              vous avez besoin d&apos;un contrat d&apos;habitation spécifique.
              Si tel est votre cas, faites une demande de devis en ligne. Un
              conseiller reviendra vers vous.
              <Link
                openInNewTab
