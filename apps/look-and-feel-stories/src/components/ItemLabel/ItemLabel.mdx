...
| `moreButtonLabel`   | ReactNode                                                                 | -       | Label/content for the optional more/info button.                                                                  |
| `onMoreButtonClick` | `MouseEventHandler<HTMLButtonElement>`                                    | -       | Click handler for the more/info button.                                                                           |
