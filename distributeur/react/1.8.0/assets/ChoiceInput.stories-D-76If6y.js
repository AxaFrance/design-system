import{n as e}from"./chunk-DnJy8xQt.js";import{n as t,t as n,w as r}from"./iframe-CKcycv95.js";import{n as i,pt as a,s as o,wt as s}from"./distributeur-C2ZQT8xT.js";var c,l,u,d,f,p,m=e((()=>{i(),n(),c=r(),{fn:l}=__STORYBOOK_MODULE_TEST__,u=t.type().meta({title:`Components/Form/Input/Choice`,args:{name:`placeName`,required:!0,label:`Place type`,placeholder:`Paris`,messageType:s.error,forceDisplayMessage:!1,classNameContainerInput:`col-md-10`,classNameContainerLabel:`col-md-2`,message:``,id:`uniqueid`,classModifier:[],onChange:l(),isVisible:!0,readOnly:!1,disabled:!1,value:void 0},argTypes:{onChange:{action:`onChange`},classModifier:{options:[`disabled`,`required`],control:{type:`inline-check`}},value:{options:[void 0,!0,!1],control:{type:`inline-radio`}}}}),d=u.story({name:`ChoiceInput`,render:({classModifier:e,...t})=>(0,c.jsx)(a,{classModifier:e?.join(` `),...t})}),f=u.story({name:`ChoiceInput with help button`,render:({classModifier:e,...t})=>(0,c.jsx)(a,{classModifier:e?.join(` `),...t,children:(0,c.jsx)(o,{mode:`hover`,children:`Help`})})}),d.input.parameters={...d.input.parameters,docs:{...d.input.parameters?.docs,source:{originalSource:`meta.story({
  name: "ChoiceInput",
  render: ({
    classModifier,
    ...args
