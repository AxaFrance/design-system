import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{O as n,n as r,t as i,w as a}from"./iframe-Cq757aCd.js";import{B as o,C as s,E as c,F as l,G as u,I as d,J as f,K as p,Ot as m,P as h,S as g,T as _,V as v,W as y,X as b,b as x,bt as S,et as C,g as w,gt as T,n as E,nt as D,q as O,v as k,w as A,x as j,y as M}from"./distributeur-Dy1QNIrM.js";var N,P,F,I,L;t((()=>{p(),E(),N=e(n(),1),i(),P=a(),F=r.type().meta({title:`Layout/Demo Page`,parameters:{options:{withAnchorNavBar:!0}},argTypes:{withAnchorNavBar:{control:`boolean`,description:`Whether to display the anchor navigation bar`,defaultValue:!1}},tags:[`!autodocs`]}),I=F.story({name:`Demo`,render:({withAnchorNavBar:e})=>{let[t,n]=(0,N.useState)(`edited`),[r,i]=(0,N.useState)({}),a={"text-input":`Default text`,"text-disabled":`Disabled default`,"text-error":`Error default`,password:`secret`,comments:`Default comment`,"select-example":`2`,accept:[`yes`],delivery:`std`};return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(y,{children:(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(d,{alt:``,img:O,onClick:()=>{},title:`Demo application`,subtitle:`Demonstrating our layout`}),(0,P.jsx)(o,{infos:[{definition:`0123456789 - NOM`,word:`Customer :`},{definition:`000123456789`,word:`Wallet:`},{definition:`New business`,word:`Status :`}]}),(0,P.jsx)(l,{name:`Jean Agent`,profile:`AGA`})]})}),(0,P.jsx)(v,{title:`Demo page`,anchorNavBarItems:e?[{name:`Accueil`,link:`#accueil`,isActive:!0},{name:`À Propos`,link:`#apropos`},{name:`Services`,link:`/services`,externalLink:!0},{name:`Contact`,link:`#contact`}]:void 0}),(0,P.jsxs)(k,{children:[(0,P.jsx)(M,{id:`step-risk`,title:`Risk analysis`,number:1,mode:`active`}),(0,P.jsx)(M,{id:`step-price`,title:`Offers`,number:2,mode:`disabled`}),(0,P.jsx)(M,{id:`step-contract`,title:`Contract information`,number:3,mode:`disabled`}),(0,P.jsx)(M,{id:`step-confirmation`,title:`Confirmation`,mode:`disabled`})]}),(0,P.jsxs)(h,{children:[(0,P.jsxs)(c,{classModifier:`lg`,children:[(0,P.jsx)(_,{title:`Policy details`,subtitle:`Contract n° 000123456789`,rightTitle:`Based on last update: 12/03/2024`}),(0,P.jsx)(g,{children:(0,P.jsxs)(x,{title:`Client information`,children:[(0,P.jsxs)(j,{children:[(0,P.jsx)(A,{label:`Adress`,children:`168 High Holborn, London WC1V 7AA, UK`}),(0,P.jsx)(A,{label:`Job`,children:`Alchemist`}),(0,P.jsx)(A,{label:`Beverages`,classModifier:`marge`,children:(0,P.jsx)(s,{values:[`Hoppiness manager`,`Tea maker`,`Coffee brewer`,`Juice extractor`]})})]}),(0,P.jsxs)(j,{classModifier:`test`,children:[(0,P.jsx)(A,{label:`Favorite color`,children:`Blue`}),(0,P.jsx)(A,{label:`Favorite movie`,children:`The Lord of the Rings`}),(0,P.jsx)(A,{label:`Favorite series`,children:`Game of Thrones`})]})]})})]}),(0,P.jsx)(w,{form:(0,P.jsxs)(`form`,{onSubmit:e=>{e.preventDefault();let t=e.currentTarget,r=new FormData(t),o={};for(let[e,t]of r.entries())Object.prototype.hasOwnProperty.call(o,e)?Array.isArray(o[e])?o[e].push(t):o[e]=[o[e],t]:o[e]=t;Object.keys(a).forEach(e=>{o[e]===void 0&&(o[e]=a[e])}),i(o),n(`validated`)},children:[(0,P.jsx)(b,{label:`Text input`,name:`text-input`,placeholder:`Type here`,defaultValue:a[`text-input`]}),(0,P.jsx)(b,{label:`Text input (disabled)`,name:`text-disabled`,disabled:!0,defaultValue:a[`text-disabled`]}),(0,P.jsx)(b,{label:`Text input (error)`,name:`text-error`,message:`This field has an error`,classModifier:`error`,defaultValue:a[`text-error`]}),(0,P.jsx)(D,{label:`Password`,name:`password`,placeholder:`••••••`,defaultValue:a.password}),(0,P.jsx)(f,{label:`Comments`,name:`comments`,placeholder:`Write a comment`,defaultValue:a.comments}),(0,P.jsx)(C,{label:`Choose option`,name:`select-example`,options:[{label:`One`,value:`1`},{label:`Two`,value:`2`}],defaultValue:a[`select-example`]}),(0,P.jsx)(S,{label:`Accept terms`,name:`accept`,options:[{label:`I accept`,value:`yes`}],values:a.accept}),(0,P.jsx)(T,{label:`Delivery`,name:`delivery`,options:[{label:`Standard`,value:`std`},{label:`Express`,value:`exp`}],value:a.delivery}),(0,P.jsx)(m,{type:`submit`,variant:`validated`,children:`Submit`})]}),title:`Client information`,stepMode:t,onEdit:()=>{n(`edited`)},restitution:(0,P.jsx)(c,{children:(0,P.jsx)(g,{children:(0,P.jsxs)(x,{children:[(0,P.jsxs)(j,{children:[(0,P.jsx)(A,{label:`Text input`,children:r[`text-input`]}),(0,P.jsx)(A,{label:`Comments`,children:r.comments}),(0,P.jsx)(A,{label:`Choose option`,children:r[`select-example`]})]}),(0,P.jsxs)(j,{children:[(0,P.jsx)(A,{label:`Accept terms`,children:Array.isArray(r.accept)?r.accept.join(`, `):String(r.accept)}),(0,P.jsx)(A,{label:`Delivery`,children:r.delivery})]})]})})})})]}),(0,P.jsx)(u,{children:`© AXA 2040 - All rights reserved`})]})}}),I.input.parameters={...I.input.parameters,docs:{...I.input.parameters?.docs,source:{originalSource:`meta.story({
  name: "Demo",
  render: ({
    withAnchorNavBar
  }) => {
