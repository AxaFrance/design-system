import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{a7 as j}from"./EditorialMessage-DERao45K.js";import"./getClassName-C9dUI_Mz.js";import"./index-CtOEgLBf.js";import{fn as A}from"./index-CH2Su9EI.js";const M=[void 0,"success","info","warning","error"],o={options:M,control:{type:"inline-radio"},table:{type:{summary:"string"},category:"Style"},description:"Variant of the message. Used to determine the icon and style of the message."},S={title:"Components/Message",component:j,args:{onClose:A()},argTypes:{classModifier:o,variant:o,onClose:{action:"close",description:"Function called when the close button is clicked.",table:{category:"Events"}},closeButtonAriaLabel:{control:{type:"text"},description:"Aria label for the close button.",table:{category:"Accessibility"}},title:{control:{type:"text"},description:"Title of the message.",table:{category:"Content",type:{summary:"ReactNode"}}},children:{control:{type:"text"},table:{category:"Content",type:{summary:"ReactNode"}},description:"Content of the message."}}},s={args:{title:"Error: some fields are invalid",closeButtonAriaLabel:"close message",children:e.jsxs("ul",{children:[e.jsxs("li",{children:["Last name is ",e.jsx("strong",{children:"required"})]}),e.jsxs("li",{children:["First name is ",e.jsx("strong",{children:"required"})]}),e.jsxs("li",{children:["Email is ",e.jsx("strong",{children:"required"})]}),e.jsxs("li",{children:["Date format is ",e.jsx("strong",{children:"invalid"})]})]})},argTypes:{classModifier:o,variant:o,title:{type:"string"}}},t={args:{variant:"warning",title:"Attention: des informations sont manquantes",closeButtonAriaLabel:"close"}},r={args:{variant:"info",title:"Attention: des informations sont manquantes",closeButtonAriaLabel:"close"}},n={args:{variant:"success",title:"Succès: votre demande a bien été enregistrée.",closeButtonAriaLabel:"close alert"}},a={args:{variant:"error",title:"Erreur dans les champs suivants :",closeButtonAriaLabel:"close",children:e.jsxs("ul",{children:[e.jsx("li",{children:"Le nom est obligatoire"}),e.jsx("li",{children:"Le prénom est obligatoire"}),e.jsx("li",{children:"L'email est obligatoire"}),e.jsx("li",{children:"Le format de date est invalide"})]})}};var i,l,c;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
