import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{n,t as r,w as i}from"./iframe-B3-wvepV.js";import{W as a,Z as o,_ as s,kt as c,n as l}from"./distributeur-y5mpDjij.js";var u=t({Template:()=>g,TitleWithContent:()=>_,WithoutDivider:()=>v,__namedExportsOrder:()=>y,default:()=>m}),d,f,p,m,h,g,_,v,y,b=e((()=>{l(),r(),d=i(),f=[``,`content`],p=[`Button`,`Link`,`None`],m=n.type().meta({title:`Components/Title`,args:{children:`Sample Title`,classModifier:``,className:``,heading:`h2`,withDivider:!0,contentLeft:`None`,contentRight:`None`},argTypes:{contentLeft:{options:p,control:{type:`select`}},contentRight:{options:p,control:{type:`select`}},classModifier:{options:f,control:{type:`select`}}}}),h=e=>{switch(e){case`Link`:return(0,d.jsx)(a,{href:`/`,children:`Click me`});case`Button`:return(0,d.jsx)(c,{children:`Click me`});default:return}},g=m.story({name:`Title`,render:({children:e,classModifier:t,...n})=>(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{classModifier:t,...n,contentLeft:void 0,contentRight:void 0,children:e}),(0,d.jsx)(o,{label:`Sample Input to illustrate bottom margin`,required:!0})]}),args:{children:`Sample Title`,classModifier:``,className:``,heading:`h2`,withDivider:!0},argTypes:{contentLeft:{control:!1},contentRight:{control:!1}}}),_=m.story({render:({children:e,contentLeft:t,contentRight:n,heading:r,withDivider:i})=>(0,d.jsx)(s,{heading:r,withDivider:i,contentLeft:h(t),contentRight:h(n),children:e}),args:{children:`Title with content`,heading:`h2`,withDivider:!0,contentLeft:`Button`,contentRight:`Link`}}),v=m.story({render:({children:e,heading:t})=>(0,d.jsx)(s,{heading:t,withDivider:!1,children:e}),args:{children:`Title without divider`,heading:`h2`,withDivider:!1},argTypes:{classModifier:{control:!1},className:{control:!1},contentLeft:{control:!1},contentRight:{control:!1}}}),g.input.parameters={...g.input.parameters,docs:{...g.input.parameters?.docs,source:{originalSource:`meta.story({
  name: "Title",
  render: ({
    children: text,
    classModifier,
