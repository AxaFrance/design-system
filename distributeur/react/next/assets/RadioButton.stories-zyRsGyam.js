import{n as e}from"./chunk-DnJy8xQt.js";import{n as t,t as n,w as r}from"./iframe-BmTal37z.js";import{s as i,t as a}from"./distributeur-experimental-DNajU_6i.js";var o,s,c,l,u,d=e((()=>{a(),n(),o=r(),s=t.meta({title:`Experimental/Form/Radio/RadioButton`,component:i,argTypes:{"aria-invalid":{control:`boolean`,name:`aria-invalid`}}}),c=s.story({name:`Default`,render:e=>(0,o.jsx)(i,{...e}),args:{id:`radio1`,name:`example`,value:`option1`,label:`Option 1`}}),l=s.story({name:`States`,render:()=>(0,o.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`1rem`},children:[(0,o.jsx)(i,{id:`radio1`,name:`example`,value:`option1`,label:`Option 1`}),(0,o.jsx)(i,{id:`radio2`,name:`example`,value:`option2`,label:`Option 2`,checked:!0}),(0,o.jsx)(i,{id:`radio3`,name:`example`,value:`option3`,label:`Option 3`,disabled:!0}),(0,o.jsx)(i,{id:`radio4`,name:`example`,value:`option4`,label:`Option 4`,"aria-invalid":!0})]})}),c.input.parameters={...c.input.parameters,docs:{...c.input.parameters?.docs,source:{originalSource:`meta.story({
  ...
  render: () => <div style={{
    ...
    gap: "1rem"
      ...
      <RadioButton id="radio1" name="example" value="option1" label="Option 1" />
      <RadioButton id="radio2" name="example" value="option2" label="Option 2" checked />
      <RadioButton id="radio3" name="example" value="option3" label="Option 3" disabled />
      <RadioButton id="radio4" name="example" value="option4" label="Option 4" aria-invalid />
    </div>
