import{n as e}from"./chunk-DnJy8xQt.js";import{n as t,t as n,w as r}from"./iframe-DGrneR1f.js";import{n as i,rt as a,s as o,wt as s}from"./distributeur-Ci4eObXl.js";var c,l,u,d,f,p=e((()=>{i(),n(),c=r(),l=t.type().meta({title:`Components/Form/Input/Number`,args:{required:!0,classModifier:[],value:5,placeholder:`Your name`,name:`name`,id:`nameid`,readOnly:!1,disabled:!1,autoFocus:!1,className:``,label:`Your name`,helpMessage:`Aide à la saisie`,forceDisplayMessage:!1,message:``,messageType:s.error,classNameContainerLabel:`col-md-2`,classNameContainerInput:`col-md-10`,"aria-disabled":!1},argTypes:{classModifier:{options:[``,`required`,`disabled`],control:{type:`inline-check`}}}}),u=l.story({name:`NumberInput`,render:({classModifier:e,...t})=>(0,c.jsx)(a,{classModifier:e.join(` `),...t})}),d=l.story({name:`NumberInput with help button`,render:({classModifier:e,...t})=>(0,c.jsx)(a,{classModifier:e.join(` `),...t,children:(0,c.jsx)(o,{mode:`hover`,children:`Help`})})}),u.input.parameters={...u.input.parameters,docs:{...u.input.parameters?.docs,source:{originalSource:`meta.story({
  name: "NumberInput",
  render: ({
    classModifier,
    ...args
