import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{n,t as r,w as i}from"./iframe-DBP_00SS.js";import{c as a,l as o,n as s}from"./distributeur-PScE1Pjf.js";var c=t({Simple:()=>f,WithPagination:()=>p,__namedExportsOrder:()=>m,default:()=>d}),l,u,d,f,p,m,h=e((()=>{s(),r(),l=i(),{fn:u}=__STORYBOOK_MODULE_TEST__,d=n.meta({component:o,title:`Components/Table`,argTypes:{onChange:{action:`onChange`}},args:{onChange:u()}}),f=d.story({name:`Simple table`,render:()=>(0,l.jsx)(a,{children:(0,l.jsxs)(a.THead,{children:[(0,l.jsx)(a.Tr,{children:(0,l.jsx)(a.Th,{colSpan:3,children:`Some text`})}),(0,l.jsxs)(a.Tr,{children:[(0,l.jsx)(a.Th,{rowSpan:2,children:`Some text`}),(0,l.jsx)(a.Td,{children:(0,l.jsx)(`strong`,{children:`Some bold text`})}),(0,l.jsx)(a.Td,{children:`Some text`})]}),(0,l.jsxs)(a.Tr,{children:[(0,l.jsx)(a.Td,{children:`Some text`}),(0,l.jsx)(a.Td,{children:`Some text`})]}),(0,l.jsxs)(a.Tr,{children:[(0,l.jsx)(a.Td,{children:`Some text`}),(0,l.jsx)(a.Td,{children:`Some text`}),(0,l.jsx)(a.Td,{children:`Some text`})]})]})}),args:{},argTypes:{}}),p=d.story({name:`Table with pagination`,render:({currentPage:e,numberItems:t,numberPages:n,mode:r,elementsLabel:i,selectPageSizeLabel:s,...c})=>(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(a,{children:(0,l.jsxs)(a.THead,{children:[(0,l.jsx)(a.Tr,{children:(0,l.jsx)(a.Th,{colSpan:3,children:`Some text`})}),(0,l.jsxs)(a.Tr,{children:[(0,l.jsx)(a.Th,{rowSpan:2,children:`Some text`}),(0,l.jsx)(a.Td,{children:(0,l.jsx)(`strong`,{children:`Some bold text`})}),(0,l.jsx)(a.Td,{children:`Some text`})]}),(0,l.jsxs)(a.Tr,{children:[(0,l.jsx)(a.Td,{children:`Some text`}),(0,l.jsx)(a.Td,{children:`Some text`})]}),(0,l.jsxs)(a.Tr,{children:[(0,l.jsx)(a.Td,{children:`Some text`}),(0,l.jsx)(a.Td,{children:`Some text`}),(0,l.jsx)(a.Td,{children:`Some text`})]})]})}),(0,l.jsx)(o,{currentPage:e,numberItems:t,numberPages:n,mode:r,elementsLabel:i,selectPageSizeLabel:s,...c})]}),args:{currentPage:3,numberItems:1e3,numberPages:10,mode:`default`,elementsLabel:`sinistres`,items:[5,10,50,100],selectAriaLabel:`Select`},argTypes:{currentPage:{control:{type:`number`},description:`Numéro de page actuelle`},numberItems:{control:{type:`number`},description:`Nombre d'élément à afficher`},numberPages:{control:{type:`number`},description:`Nombre de pages`},mode:{options:[`default`,`light`],control:{type:`radio`},description:`Choix du mode d'affichage`},elementsLabel:{type:`string`,description:`Label utilisé dans les liens vers les page. Doit représenter ce que contient le tableau associé`},selectPageSizeLabel:{description:`Label du select pour choisir le nombre d'éléments à afficher`,control:{type:`text`},type:`string`},items:{description:`Les différentes options de choix pour le nombre d'élément à afficher`},onChange:{table:{disable:!0}}}}),f.input.parameters={...f.input.parameters,docs:{...f.input.parameters?.docs,source:{originalSource:`meta.story({
  name: "Simple table",
  render: () => <Table>
      <Table.THead>
        <Table.Tr>
