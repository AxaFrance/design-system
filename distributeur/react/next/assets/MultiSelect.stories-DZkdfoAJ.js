import{a as e,n as t,r as n}from"./chunk-DnJy8xQt.js";import{O as r,n as i,t as a,w as o}from"./iframe-Cq757aCd.js";import{Tt as s,c,ct as l,n as u,st as d}from"./distributeur-Dy1QNIrM.js";var f=n({MultiSelectInputStory:()=>S,MultiSelectInputWithChildrenStory:()=>C,MultiSelectOneValueStory:()=>x,MultiSelectStory:()=>b,__namedExportsOrder:()=>w,default:()=>g}),p,m,h,g,_,v,y,b,x,S,C,w,T=t((()=>{u(),p=e(r(),1),a(),m=o(),{fn:h}=__STORYBOOK_MODULE_TEST__,g=i.meta({title:`Components/Form/Input/MultiSelect`,component:l,argTypes:{onChange:{action:`onChange`}},args:{onChange:h()}}),_=[{value:`fun`,label:`For fun`,clearableValue:!1},{value:`work`,label:`For work`},{value:`drink`,label:`For drink`},{value:`sleep`,label:`For sleep`},{value:`swim`,label:`For swim`}],v=[`work`,`drink`],y={name:`multiSelectName`,options:_,disabled:!1,required:!0,placeholder:`- Sélectionner -`},b=g.story({name:`MultiSelect`,render:({values:e,onChange:t=()=>{},...n})=>{let[r,i]=(0,p.useState)(e);return(0,m.jsx)(`form`,{className:`af-form`,name:`myform`,children:(0,m.jsx)(l,{values:r,onChange:e=>{i(e.values),t(e)},...n})})},args:{...y,values:v,menuPortalTarget:document.body},argTypes:{onChange:{action:`onChange`}}}),x=g.story({name:`MultiSelect with one value`,render:({value:e,onChange:t=()=>{},...n})=>{let[r,i]=(0,p.useState)(e);return(0,m.jsx)(`form`,{className:`af-form`,name:`myform`,children:(0,m.jsx)(l,{value:r,onChange:e=>{i(e.value),t(e)},...n})})},args:{...y,value:``,menuPortalTarget:document.body},argTypes:{onChange:{action:`onChange`}}}),S=g.story({name:`MultiSelectInput`,render:({values:e,onChange:t=()=>{},...n})=>{let[r,i]=(0,p.useState)(e);return(0,m.jsx)(`form`,{className:`af-form`,name:`myform`,children:(0,m.jsx)(d,{label:`Place type`,values:r,onChange:e=>{i(e.values),t(e)},...n})})},args:{...y,values:v,id:`uniqueid`,label:`Place type`,helpMessage:`Enter the place type`,messageType:s.error,forceDisplayMessage:!1,message:``,isVisible:!0,classModifier:``,classNameContainerLabel:`col-md-2`,classNameContainerInput:`col-md-10`,selectedLimit:3,selectedLimitLabel:``,menuPortalTarget:document.body},argTypes:{onChange:{action:`onChange`}}}),C=g.story({name:`MultiSelectInput with help button`,render:({values:e,onChange:t=()=>{},...n})=>{let[r,i]=(0,p.useState)(e);return(0,m.jsx)(`form`,{className:`af-form`,name:`myform`,children:(0,m.jsx)(d,{label:`Place type`,values:r,onChange:e=>{i(e.values),t(e)},...n,children:(0,m.jsx)(c,{mode:`hover`,children:`Help`})})})},args:{...y,values:v,id:`uniqueid`,label:`Place type`,helpMessage:`Enter the place type`,message:``,isVisible:!0,classModifier:``,selectedLimit:3,selectedLimitLabel:``,menuPortalTarget:document.body},argTypes:{onChange:{action:`onChange`}}}),b.input.parameters={...b.input.parameters,docs:{...b.input.parameters?.docs,source:{originalSource:`meta.story({
  name: "MultiSelect",
  render: ({
    values,
    onChange = () => {},
