import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{k as n}from"./iframe-C61lZro3.js";import{t as r}from"./jsx-runtime-CXZ2plg1.js";import{G as i,d as a,f as o,t as s}from"./client-Cujgwaot.js";import{M as c,P as l}from"./TimelineVerticalCommon-CJLC-eKw.js";import{n as u,r as d,t as f}from"./account_balance-COI8I6-Y.js";var p,m,h,g,_,v,y=t((()=>{d(),s(),u(),p=e(n(),1),m=r(),{fn:h}=__STORYBOOK_MODULE_TEST__,g={title:`Components/Modal/ModalCore`,component:l,parameters:{layout:`fullscreen`},args:{onSubmit:h(),onCancel:h(),onClose:h()}},_={decorators:[(e,{args:t})=>{let n=(0,p.useRef)(null),r=()=>{n.current?.close(),t.onClose?.()},s=(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(a,{headingProps:{children:t.title},iconProps:{src:f},onClose:r}),(0,m.jsx)(c,{children:t.children}),(0,m.jsx)(o,{primaryButtonProps:{children:`Valider`},secondaryButtonProps:{children:`Annuler`}})]});return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`div`,{style:{padding:8},children:(0,m.jsx)(i,{onClick:()=>n.current?.showModal(),children:`Open the modal`})}),(0,m.jsx)(e,{args:{...t,ref:n,onClose:r,children:s}})]})}],args:{open:!1,title:`Modal title`,children:(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`p`,{className:`paragraph`,children:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse consectetur urna a tellus semper, id elementum ligula fermentum. In semper quis mi eu commodo. Vivamus in metus eros. Sed ut pellentesque purus. Maecenas congue ornare massa quis porttitor. Nullam ut diam dapibus, consequat libero eget, faucibus nibh. Etiam imperdiet metus at nulla fermentum semper. In ipsum urna, tempus vel lorem vel, venenatis malesuada dui. Cras massa ipsum, accumsan et scelerisque ut, vulputate at elit.`}),(0,m.jsx)(`p`,{className:`paragraph`,children:`Donec non quam neque. Nullam fermentum erat in sem fermentum euismod. Phasellus sollicitudin condimentum diam ut euismod. Duis nec bibendum metus. Ut convallis tincidunt risus. Nam vel ultricies augue. Donec malesuada dolor et ligula egestas, sit amet ultrices libero bibendum. Phasellus varius pulvinar lectus, a ultrices risus tempus ut. Aliquam faucibus tortor lorem, et mattis dolor efficitur quis. Pellentesque ipsum nunc, finibus nec velit eget, sodales lobortis leo.`}),(0,m.jsx)(`p`,{className:`paragraph`,children:`Pellentesque venenatis est quis aliquam tristique. In tincidunt orci ac ipsum vulputate, quis mattis orci commodo. Pellentesque at hendrerit felis, pulvinar porttitor lorem. Sed vulputate quis diam sit amet ultricies. Cras non nisl pharetra, ornare lectus sed, fringilla turpis. Cras molestie velit in enim pretium, id vestibulum est luctus. Ut mattis consequat magna, ac scelerisque massa consequat in. Proin euismod pulvinar congue. Donec dapibus lorem tellus, dapibus dignissim elit condimentum non. Donec luctus nulla a turpis mattis, vehicula posuere quam convallis. Nullam gravida ante rutrum purus efficitur hendrerit. Aenean magna tortor, cursus at ligula vel, aliquet iaculis arcu. Praesent varius, purus eget interdum tempor, magna nisi pretium neque, pharetra viverra leo neque at est.`})]})}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  decorators: [(Story, {
    args
  }) => {
...
}`,..._.parameters?.docs?.source}}},v=[`ModalCore`]}));y();export{_ as ModalCore,v as __namedExportsOrder,g as default,y as t};