import"./CheckboxCardApollo-CXMmk4K0.js";import{j as n}from"./jsx-runtime-D_zvdyIk.js";import"./index-DuZrfDUH.js";import{T as o,t as m}from"./TagCommon-BP_-Kr0i.js";const g=()=>n.jsx("div",{className:"af-tag-client-demo",children:Object.values(m).map(e=>n.jsx(o,{variant:e,children:e},e))}),T=({children:e,variant:s,...u})=>n.jsxs(o,{variant:s,...u,children:[e," ",s]});g.__docgenInfo={description:"",methods:[],displayName:"renderTagAll"};T.__docgenInfo={description:"",methods:[],displayName:"renderTag"};const y={component:o,title:"Components/Tag",parameters:{layout:"centered"},argTypes:{}},r={name:"Tag",render:T,args:{children:"Tag",variant:"info"},argTypes:{variant:{options:Object.values(m),control:{type:"select"}}}},a={render:g};var t,c,d;r.parameters={...r.parameters,docs:{...(t=r.parameters)==null?void 0:t.docs,source:{originalSource:`{
  name: "Tag",
  render: renderTag,
  args: {
    children: "Tag",
