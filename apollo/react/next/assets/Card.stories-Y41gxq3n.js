import{j as e}from"./index-C-iqcyhV.js";import{s as _,H as j}from"./CardApollo-Ct2KtOfb.js";import"./index-ZnYipkzV.js";const s=({as:r,children:C,className:p,...u})=>{const g=r||"div";return e.jsx(g,{className:_({baseClassName:"af-card",className:p}),...u,children:C})},m=e.jsxs(e.Fragment,{children:[e.jsx(j,{level:2,className:"af-card__title",children:"My card title"}),e.jsx("p",{children:"My card content"})]}),x={title:"Components/Card",component:s},n={name:"Basic Content",render:r=>e.jsx(s,{...r}),args:{children:m}},a={render:r=>e.jsx(s,{...r}),args:{children:m,as:"button",type:"button"},argTypes:{onClick:{action:"onClick"}}};var t,o,c;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`{
  name: "Basic Content",
