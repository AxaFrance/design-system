import{j as u}from"./jsx-runtime-D_zvdyIk.js";import{a}from"./ToggleCommon-CJV8peaY.js";import"./index-DuZrfDUH.js";import{h as e}from"./home-BuLaEOyh.js";const d={title:"Components/Form/Checkbox/CheckboxCard",component:a,argTypes:{}},n={name:"CheckboxCard",render:({...r})=>u.jsx(a,{...r}),args:{type:"vertical",isRequired:!0,options:[{label:"Paris",description:"Capitale de la France",subtitle:"Nord",name:"paris",value:"paris",icon:e},{label:"Bruxelles",description:"Capitale de la Belgique",name:"bruxelles",value:"bruxelles",hasError:!0,icon:e},{label:"Lille",name:"lille",value:"lille",icon:e,checked:!0}]},argTypes:{type:{control:{type:"inline-radio"},options:["vertical","horizontal"]},options:{control:{type:"object"}},onChange:{action:"onChange"}}},o={name:"CheckboxCardWithLabel",render:({...r})=>u.jsx(a,{...r}),args:{type:"vertical",labelGroup:"Quelle ville ?",descriptionGroup:"Choisissez une ville",isRequired:!0,options:[{label:"Paris",description:"Capitale de la France",subtitle:"Nord",name:"paris",value:"paris",icon:e},{label:"Bruxelles",description:"Capitale de la Belgique",name:"bruxelles",value:"bruxelles",hasError:!0,icon:e},{label:"Lille",name:"lille",value:"lille",icon:e,checked:!0}]},argTypes:{type:{control:{type:"inline-radio"},options:["vertical","horizontal"]},options:{control:{type:"object"}},onChange:{action:"onChange"}}};var l,i,t;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  name: "CheckboxCard",
  render: ({
    ...args
  }) => <CheckboxCard {...args} />,
