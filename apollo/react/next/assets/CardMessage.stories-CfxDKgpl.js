import{j as a}from"./index-DK-fRI8B.js";import{l as g}from"./DropdownCommon-Du-N2swA.js";import{r as p}from"./index-DbaA8R3S.js";const u={info:"info",warning:"warning",error:"error",neutral:"neutral"},i=({variant:s="info",title:r,text:l,className:t,...m})=>{const d=p.useMemo(()=>g("af-card-message",t,s),[t,s]);return a.jsxs("div",{...m,className:d,children:[r&&a.jsx("span",{className:"af-card-message--title",children:r}),a.jsx("span",{className:"af-card-message--text",children:l})]})},f={component:i,title:"Components/CardMessage"},e={name:"CardMessage",render:({...s})=>a.jsx(i,{...s}),args:{title:"Title",text:"This is a message"},argTypes:{variant:{options:Object.values(u),control:{type:"select"}}}};var n,o,c;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  name: "CardMessage",
  render: ({
    ...args
  }) => <CardMessage {...args} />,
