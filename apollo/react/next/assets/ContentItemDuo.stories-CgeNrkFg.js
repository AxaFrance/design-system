import{j as e}from"./index-DK-fRI8B.js";import{h as b,B as y}from"./DropdownCommon-DqlHmzcC.js";import{r as L}from"./index-DbaA8R3S.js";const N=({label:s,value:t,isVertical:i=!1,className:l,classModifier:c,buttonText:u,onButtonClick:h,ButtonComponent:_})=>{const I=L.useMemo(()=>{const d=[c];return i&&d.push("vertical"),b("af-content-item-duo",l,d.filter(Boolean).join(" "))},[c,l,i]);return e.jsxs("div",{className:I,children:[e.jsx("p",{className:"af-content-item-duo__label",children:s}),typeof t=="string"?e.jsx("p",{className:"af-content-item-duo__value",children:t}):e.jsx("div",{className:"af-content-item-duo__value",children:t}),u&&e.jsx("div",{className:"af-content-item-duo__button",children:e.jsx(_,{variant:"ghost",onClick:h,children:u})})]})},a=s=>e.jsx(N,{...s,ButtonComponent:y}),S={title:"Components/List/ContentItemDuo",component:a},D={isVertical:!1,label:"Libellé",value:"Réponse",buttonText:"En savoir plus"},A={isVertical:!0,label:"Le choc de véhicules terrestres à moteur, (voiture, trottinette à moteur…) ou la chute d’appareils aériens (avions, hélicoptères…) avec un propriétaire du véhicule adverse identifié ?",value:"Les incendies, explosions, implosions, fumée et foudre",buttonText:"En savoir plus",classModifier:[]},o={render:({classModifier:s,...t})=>e.jsx(a,{classModifier:s.join(" "),...t}),args:{...D,classModifier:["small"]}},r={render:({classModifier:s,...t})=>e.jsx(a,{classModifier:s.join(" "),...t}),args:{...D,classModifier:["large"]}},n={render:({classModifier:s,...t})=>e.jsx(a,{classModifier:s.join(" "),...t}),args:A,argTypes:{classModifier:{options:["large"],control:{type:"multi-select"},defaultValue:[]}}};var m,p,f;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: ({
    classModifier,
    ...args
